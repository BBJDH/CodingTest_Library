...
_int2 Direction[4] = { {1,0}, {0,1}, {-1,0}, {0,-1} }; //RDLU
...
{
	if (Visit[Next.RedPos.Y][Next.RedPos.X][Next.BluePos.Y][Next.BluePos.X] == false and Next.Count <= 10)
	{
...
void RoundEdges(Node const& Current)
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		{
			//RDLU
		case 0: AddPath = "R"; break;
		case 1: AddPath = "D"; break;
		case 2: AddPath = "L"; break;
		case 3: AddPath = "U"; break;
		}

		Next = { Current.RedPos, Current.BluePos, Current.Count + 1,Current.Path+ AddPath };
